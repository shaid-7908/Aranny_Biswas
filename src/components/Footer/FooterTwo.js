            ...
            <div className="col-sm-6 col-md-4">
              <div className="widget widget-text">
                ...
                <div className="widget-links">
                  <ul>
                    <li>Dumuradah,Hoogly,712515</li>
                    <li>
                      <a href="tel:8116116800">81161 16800</a>
                    </li>
          ...
          <div className="row">
            <div className="col-md-6 col-xs-12">
              <ul className="social-media">
                ...
                <li>
                  <a
                    href={"https://www.facebook.com/aranya.biswas.543"}
            ...
            <div className="col-md-6 col-xs-12">
              <div className="copy-right text-right">
                © {new Date().getFullYear()} Arannya. All rights reserved
              </div>
            </div>
          </div>
        </div>
